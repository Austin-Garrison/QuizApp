...
import com.zybooks.quizapp.OptionTypes
import com.zybooks.quizapp.Questions
...
class QuestionActivity : AppCompatActivity() {
    ...
    private var questionList:ArrayList<OptionTypes> ? = null
    private var selecedOption:Int=0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_question)

        Name=intent.getStringExtra(Questions.name)
        ...
        submit.setOnClickListener {
            if(selecedOption!=0)
            {
                ...
                if(selecedOption!=question.correct_answer) {
                    score++;
                }
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(Questions.name,Name.toString())
                        intent.putExtra(Questions.score,score.toString())
